...
minetest.register_node("default:tree", {
	...
	node_box = {
		...
		fixed = {
			...
			{-0.3125, -0.5, 0.375, 0.3125, 0.5, 0.4375}, -- NodeBox2
			{-0.1875, -0.5, 0.4375, 0.1875, 0.5, 0.5}, -- NodeBox3
			{-0.3125, -0.5, -0.4375, 0.3125, 0.5, -0.375}, -- NodeBox4
			{-0.1875, -0.5, -0.5, 0.1875, 0.5, -0.4375}, -- NodeBox5
			{-0.4375, -0.5, -0.3125, -0.375, 0.5, 0.3125}, -- NodeBox6
			{-0.5, -0.5, -0.1875, -0.4375, 0.5, 0.1875}, -- NodeBox7
			{0.375, -0.5, -0.3125, 0.4375, 0.5, 0.3125}, -- NodeBox8
			{0.4375, -0.5, -0.1875, 0.5, 0.5, 0.1875}, -- NodeBox9
		}
	},
	is_ground_content = false,
	groups = {tree=1,trunk=1,treedecay=1,choppy=2,oddly_breakable_by_hand=1,flammable=2},
...
minetest.register_node("default:leaves", {
	...
	waving = 1,
	visual_scale = 1.3,
	tiles = {"default_branches.png^default_leaves.png"},
	paramtype = "light",
	is_ground_content = false,
...
minetest.register_node("default:cactus", {
	...
	paramtype2 = "facedir",
	is_ground_content = true,
	groups = {snappy=1,tree=1,treedecay=1,choppy=3,flammable=2},
	sounds = default.node_sound_wood_defaults(),
	on_place = minetest.rotate_node,
